...
%token INT FLOAT LONG UNSIGNED SIGNED DOUBLE CHAR VOID STRUCT 
...
direct_declarator
    ...
    | direct_declarator OPEN_BRACKET { 
        symbol_table[func_identifier].usage += "ARRAY ";
        type_string = "";
        storage_class_string = "";
    } constant_exp CLOSE_BRACKET
    | direct_declarator OPEN_BRACKET { 
        symbol_table[func_identifier].usage += "ARRAY ";
        type_string = "";
        storage_class_string = "";
    ...
    | direct_declarator OPEN_PARANTHESES { 
        symbol_table[func_identifier].usage += "PROCEDURE ";
        type_string = "";
        storage_class_string = "";
    ...
    | direct_declarator OPEN_PARANTHESES { 
        ...
        type_string = "";
        storage_class_string = "";
    } identifier_list CLOSE_PARANTHESES
